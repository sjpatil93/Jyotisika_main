...
const Navbar = () => {
  ...
  return (
    <nav className="navbar navbar-expand sticky-top" style={{ backgroundColor: '#FEFAEA', height: '90px', justifyContent: 'center', alignItems: 'center' }}>
      <div className="container-fluid px-0 mx-3">
        ...
        <div className=" navbar-collapse w-100" id="navbarSupportedContent" style={{ backgroundColor: '#FEFAEA' }}>
