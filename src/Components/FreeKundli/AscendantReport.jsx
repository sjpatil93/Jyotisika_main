...
const AscendantReport = () => {
  const [formData, setFormData] = useState({
    ...
    boy_lon: '',
    language: '',
    astro_feature: 'ascendant_report',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    const apiUrl = `${baseUrl}User_Api_Controller/ascendant_report`;
    try {
  ...
  const renderResult = () => {
    ...
    const ascendant = result.data.data;
    return (
      <>
        <div className="alert alert-success mb-3 ">Ascendant Report Loaded</div>
        <div className="row mb-4">
          <div className="col-md-4 text-center">
            <img
              src={ascendant.image}
              alt={ascendant.ascendant}
              className="img-fluid rounded shadow"
              style={{ maxHeight: '250px' }}
            />
            <h5 className="mt-2">{ascendant.ascendant || 'N/A'}</h5>
          </div>
        ...
        {ascendant.analysis && ascendant.analysis.content && (
          <div className="card mt-4 shadow-sm">
            <div className="card-header bg-primary text-white">Detailed Analysis</div>
            <div className="card-body">{ascendant.analysis.content}</div>
          </div>
        )}
        {(ascendant.sign || ascendant.degree || ascendant.nakshatra) && (
        ...
        <div className="free-kundli flex-grow-1">
          <div className="container px-0 pb-5">
            ...
            <div
              ...
              /* TODO: responsive height equivalents for h-[200/250/300] */
              style={{ height: 300 }}
            >
              <div className="position-relative w-100 h-100">
                ...
                >
                  ...
                  <p className="text-light small lh-sm text-start" style={{ maxWidth: 483 }}>
                    Explore the first impression of your soul through the Ascendant Report. Get insights
                ...
                <div className="d-flex flex-column align-items-center gap-3">
                  <div className="d-flex flex-column align-items-center gap-2" style={{ maxWidth: 669 }}>
                    <div className="d-flex flex-column align-items-center gap-2" style={{ maxWidth: 501 }}>
                      ...
                      <p className="text-dark fw-medium fs-5 text-center">{/* fw-medium ~ fw-semibold if unavailable */} 
                        Get Your Ascendant Report by Date of Birth
                      </p>
                    </div>
                  ...
                  <div className="row g-3 w-100">
                    ...
                    <input type="hidden" id="astro_feature" name="astro_feature" value="ascendant_report" />
                    ...
                    <div className="col-12 pt-3">
                      <button
                        ...
                        /* TODO: original two-color gradient (from/to) */
                      >
